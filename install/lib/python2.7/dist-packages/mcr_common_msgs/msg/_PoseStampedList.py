...
"""autogenerated by genpy from mcr_common_msgs/PoseStampedList.msg. Do not edit."""
import sys
...
class PoseStampedList(genpy.Message):
  _md5sum = "f4bbbec105a3dc69d6c5974def547813"
  _type = "mcr_common_msgs/PoseStampedList"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This messages represents a list of  poses with reference
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseStampedList, self).__init__(*args, **kwds)
