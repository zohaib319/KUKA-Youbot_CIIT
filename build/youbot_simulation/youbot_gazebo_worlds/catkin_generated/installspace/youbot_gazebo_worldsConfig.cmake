...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'youbot_gazebo_worlds' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hp/c_w/install/${idir}'.  Ask the maintainer 'Walter Nowak <nowak@locomotec.com>, Sebastian Blumenthal <blumenthal@locomotec.com>' to fix it.")
    endif()
