...
if("TRUE" STREQUAL "TRUE")
  set(youbot_gazebo_robot_SOURCE_PREFIX /home/hp/c_w/src/youbot_simulation/youbot_gazebo_robot)
  set(youbot_gazebo_robot_DEVEL_PREFIX /home/hp/c_w/devel)
  ...
  set(youbot_gazebo_robot_INSTALL_PREFIX /home/hp/c_w/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'youbot_gazebo_robot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Walter Nowak <nowak@locomotec.com>, Sebastian Blumenthal <blumenthal@locomotec.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'youbot_gazebo_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hp/c_w/src/youbot_simulation/youbot_gazebo_robot/${idir}'.  Ask the maintainer 'Walter Nowak <nowak@locomotec.com>, Sebastian Blumenthal <blumenthal@locomotec.com>' to fix it.")
    endif()
...
set(depends "gazebo_ros;robot_state_publisher;youbot_gazebo_control;youbot_gazebo_worlds")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${youbot_gazebo_robot_dep}_FOUND)
      find_package(${youbot_gazebo_robot_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${youbot_gazebo_robot_dep} REQUIRED ${depend_list})
  endif()
