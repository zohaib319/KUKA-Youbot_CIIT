...
(cl:defmethod cl:initialize-instance :after ((m <Float32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcr_common_msgs-msg:<Float32Stamped> is deprecated: use mcr_common_msgs-msg:Float32Stamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Float32Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcr_common_msgs-msg:header-val is deprecated.  Use mcr_common_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Float32Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcr_common_msgs-msg:value-val is deprecated.  Use mcr_common_msgs-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Float32Stamped>)))
  ...
  "mcr_common_msgs/Float32Stamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Float32Stamped)))
  "Returns string type for a message object of type 'Float32Stamped"
  "mcr_common_msgs/Float32Stamped")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Float32Stamped>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%float32 value~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Float32Stamped)))
  "Returns full string definition for message of type 'Float32Stamped"
  (cl:format cl:nil "std_msgs/Header header~%float32 value~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
