...
if("TRUE" STREQUAL "TRUE")
  set(youbot_arm_kinematics_moveit_SOURCE_PREFIX /home/hp/c_w/src/youbot-manipulation/youbot_arm_kinematics_moveit)
  set(youbot_arm_kinematics_moveit_DEVEL_PREFIX /home/hp/c_w/devel)
  ...
  set(youbot_arm_kinematics_moveit_INSTALL_PREFIX /home/hp/c_w/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'youbot_arm_kinematics_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hp/c_w/src/youbot-manipulation/youbot_arm_kinematics_moveit/${idir}'.  Ask the maintainer 'Sven Schneider <sven.schneider@h-brs.de>' to fix it.")
    endif()
